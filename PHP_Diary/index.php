    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card__image-container">
                <img class="card__image" src="<?php echo 'images/' . e($images[$counter]); ?>"
        ...
        <ul class="pagination">
            <li class="pagination__li">
                <?php if ($page > 1): ?>
                <a class="pagination__link pagination__link--arrow" href="<?php
                            if ($page === 1) echo "index.php";
                            else echo "index.php?page=" . ($page - 1);
                            ?>">⏴</a>
                <?php endif; ?>
            </li>
            <?php for ($x = 1; $x <= $numPages; $x++): ?>
            <li class="pagination__li">
                <a class="pagination__link <?php if ($page === $x) echo "pagination__link--active"; ?>"
            ...
            <?php if ($page != $numPages): ?>
                <li class="pagination__li">
                    <a class="pagination__link pagination__link--arrow" href="<?php
                        if ($page == $numPages) echo "index.php";
                        else echo "index.php?page=" . ($page + 1);
                        ?>">⏵</a>
                </li>
            <?php endif; ?>
